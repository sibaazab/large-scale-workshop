...
func (c *Chord) GetAllKeys() ([]string, error) {
	log.Printf("ya 3me shoooooooooooooooooooooooooooo")
	if c.handle.Val == nil {
		log.Printf("c.handle is not initialized")
	}
	log.Printf("ddddddfffffffffffffffffffffffffffffffffffffffffffffffffffff")
